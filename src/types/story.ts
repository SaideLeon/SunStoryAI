...
export const STORY_STYLES = [
  ...
  { 
    ...
    prompt: 'Você é um narrador intenso de trailer de filme de ação ou suspense. Fale com alta energia, urgência e forte emphase nos momentos emocionais. Não leia estas instruções.' 
  },
  { 
    id: 'news', 
    label: 'Noticiário', 
...
export const VISUAL_STYLES = [
  ...
  { 
    ...
    promptSuffix: 'Style description: 3D anatomical skeleton character, full body visible, internal organs exposed (lungs, heart, liver, intestines), semi transparent body, medical educational illustration, stylized cartoon eyes, ultra detailed organic textures, octane render, studio lighting, soft pink gradient background, high resolution, 8k.' 
  },
  { 
    id: 'watercolor', 
